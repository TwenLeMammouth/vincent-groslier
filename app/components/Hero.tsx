  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
      <div className='col-span-1 lg:col-span-2 h-full bg-gray-100 min-h-[500px] lg:min-h-[300px] rounded-2xl p-8'>
        <h1 className='text-4xl lg:text-6xl font-medium'>Hello I am Vincent !</h1>
        <h1 className='text-2xl lg:text-4xl font-normal mt-3'>I am a Frontend Developper living in France</h1>
